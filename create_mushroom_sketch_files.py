...
from datasketches import update_theta_sketch, compact_theta_sketch
import csv
import io
import base64
...
def load_mushroom_dataset():
    ...
    data_path = Path("tests/resources/agaricus-lepiota.csv")
...
def load_sketches_from_csv(positive_file="positive_sketches.csv", negative_file="negative_sketches.csv", lg_k=16):
    ...
    with open(negative_file, 'r') as csvfile:
        ...
        for row in reader:
            ...
            if sketch_type == 'total':
                sketch_data['negative']['total'] = sketch
            elif sketch_type == 'present':
                if feature not in sketch_data['negative']:
                    sketch_data['negative'][feature] = [None, None]
                sketch_data['negative'][feature][0] = sketch
            elif sketch_type == 'absent':
                if feature not in sketch_data['negative']:
                    sketch_data['negative'][feature] = [None, None]
                sketch_data['negative'][feature][1] = sketch
...
def main():
    ...
    try:
        ...
        import json
        mapping_file = "tests/fixtures/mushroom_feature_mapping.json"
...
if __name__ == "__main__":
    sketch_data, feature_mapping = main()
